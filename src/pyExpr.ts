...
export function normalizePathForPython(path: string): string {
 ...
 */
export function pyStringExpr(text: string): string {
  const parts: string[] = [];
  let current = '';
 ...
 */
export function safeCaptureExpr(target: string): string {
